...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"درکمال تاسف ، هیچ مطلبی یافت نشد",sInfo:"مشاهده _START_ تا _END_ از _TOTAL_ مطلب",sInfoEmpty:"مشاهده 0 تا 0 از 0 مطلب",sInfoFiltered:"(جستجو شده از _MAX_  مطلب)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"مشاهده _MENU_ مطالب",sLoadingRecords:"لطفا صبور باشید ...",sProcessing:"لطفا صبور باشد ...",sSearch:"جستجو:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"مطلبی در خصوص جستجوی شما وجود ندارد."},oSearch:h.extend({},
