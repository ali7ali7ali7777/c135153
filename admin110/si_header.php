	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				$show=mysqli_fetch_assoc(mysqli_query($mysqlicheck,"SELECT * FROM #"));
                  ...
                  <div class="panel panel-flat">
                  	<form method="post" class="form-horizontal">
                		 <div class="panel-heading" style="margin-top:20px">
                            <h5 class="panel-title">هدر سایت</h5>
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="tel" name="kod" class="form-control" placeholder="کد شهر" value="<?php if($show['kod']!="") echo '0'.$show['kod'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="tel" name="mobile" class="form-control" placeholder="موبایل" value="<?php if($show['mobile']!="") echo '0'.$show['mobile'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
