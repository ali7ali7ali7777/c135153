...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>JANGO | Ultimate Multipurpose Bootstrap HTML Theme - Order History 2</title>
                ...
                <div class="c-layout-sidebar-content ">
                    ...
                    <div class="row c-margin-b-40 c-order-history-2">
                        ...
                        <div class="row c-cart-table-row">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-5 c-cart-image">
                                <img src="assets/base/img/content/shop3/10.jpg" /> </div>
                            <div class="col-md-1 col-sm-3 col-xs-6 c-cart-ref">
                                <p class="c-cart-sub-title c-theme-font c-font-uppercase c-font-bold">Order</p>
                                <p>#1106</p>
                            </div>
                            <div class="col-md-2 col-sm-6 col-xs-6 c-cart-desc">
                                <p class="c-cart-sub-title c-theme-font c-font-uppercase c-font-bold">Description</p>
                                <p>
                                    <a href="shop-product-details-2.html" class="c-font-bold c-theme-link c-font-dark">Winter Hood</a>
                                </p>
                            </div>
                        ...
                        <div class="row c-cart-table-row">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-5 c-cart-image">
                                <img src="assets/base/img/content/shop3/22.jpg" /> </div>
                            <div class="col-md-1 col-sm-3 col-xs-6 c-cart-ref">
                                <p class="c-cart-sub-title c-theme-font c-font-uppercase c-font-bold">Order</p>
                                <p>#1107</p>
                            </div>
                            <div class="col-md-2 col-sm-6 col-xs-6 c-cart-desc">
                                <p class="c-cart-sub-title c-theme-font c-font-uppercase c-font-bold">Description</p>
                                <p>
                                    <a href="shop-product-details-2.html" class="c-font-bold c-theme-link c-font-dark">Winter Coat</a>
                                </p>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-6 c-cart-price">
                                <p class="c-cart-sub-title c-theme-font c-font-uppercase c-font-bold">Price</p>
                        ...
                        <div class="row c-cart-table-row">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-5 c-cart-image">
                                <img src="assets/base/img/content/shop3/21.jpg" /> </div>
                            <div class="col-md-1 col-sm-3 col-xs-6 c-cart-ref">
                                <p class="c-cart-sub-title c-theme-font c-font-uppercase c-font-bold">Order</p>
                                <p>#1123</p>
                            </div>
                            <div class="col-md-2 col-sm-6 col-xs-6 c-cart-desc">
                                <p class="c-cart-sub-title c-theme-font c-font-uppercase c-font-bold">Description</p>
                                <p>
                                    <a href="shop-product-details-2.html" class="c-font-bold c-theme-link c-font-dark">Cotton Top</a>
                                </p>
                            </div>
                            <div class="clearfix col-md-2 col-sm-3 col-xs-6 c-cart-price">
                                <p class="c-cart-sub-title c-theme-font c-font-uppercase c-font-bold">Price</p>
                        ...
                        <div class="row c-cart-table-row">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-5 c-cart-image">
                                <img src="assets/base/img/content/shop3/23.jpg" /> </div>
                            <div class="col-md-1 col-sm-3 col-xs-6 c-cart-ref">
                                <p class="c-cart-sub-title c-theme-font c-font-uppercase c-font-bold">Order</p>
                                <p>#1136</p>
                            </div>
                            <div class="col-md-2 col-sm-6 col-xs-6 c-cart-desc">
                                <p class="c-cart-sub-title c-theme-font c-font-uppercase c-font-bold">Description</p>
                                <p>
                                    <a href="shop-product-details-2.html" class="c-font-bold c-theme-link c-font-dark">Winter Jacket</a>
                                </p>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-6 c-cart-price">
                                <p class="c-cart-sub-title c-theme-font c-font-uppercase c-font-bold">Price</p>
