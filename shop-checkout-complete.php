...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>JANGO | Ultimate Multipurpose Bootstrap HTML Theme - Checkout Complete</title>
                    ...
                    <div class="c-shop-order-complete-1 c-content-bar-1 c-align-left c-bordered c-theme-border c-shadow">
                        ...
                        <div class="c-order-details">
                            ...
                            <div class="c-border-bottom c-row-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-sm-8">
                                        <ul class="c-list list-unstyled">
                                            <li class="c-margin-b-25">
                                                <a href="shop-product-details-2.html" class="c-font-bold c-font-22 c-theme-link">Sports Wear</a>
                                            </li>
                                            <li class="c-margin-b-10">Color: Blue</li>
                                            <li>Size: S</li>
                                            <li>Quantity: x1</li>
                            ...
                            <div class="c-row-item c-row-total c-right">
                                <ul class="c-list list-unstyled">
                                    <li>
                                        <h3 class="c-font-regular c-font-22"> جمع جزئ : &nbsp;
                                            <span class="c-font-dark c-font-bold c-font-22">2.000.000 ريال</span>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3 class="c-font-regular c-font-22">هزینه ارسال : &nbsp;
                                            <span class="c-font-dark c-font-bold c-font-22">200.000 ريال</span>
                                        </h3>
                                    </li>
                                    <li>
                                        <h3 class="c-font-regular c-font-22">جمع کل : &nbsp;
                                            <span class="c-font-dark c-font-bold c-font-22">2.200.000 ريال</span>
                                        </h3>
                                    </li>
                                </ul>
                            </div>
