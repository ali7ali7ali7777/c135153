					...
					<div class="c-product-review">
                        ...
                        <form method="post">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              <label for="recipient-name" class="control-label">ایمیل شما :</label>
                              <input type="email" class="form-control c-square" id="recipient-name" name="email" >
                            </div>
                            <div class="form-group">
    ...
    <div class="tab-content">
      ...
      <div role="tabpanel" class="tab-pane fade" id="tab-3">
        <div class="container">
          ...
          <?php
$rant_t2 = mysqli_query($mysqlicheck,'SELECT * FROM comment	where comment_object_id = "'.$object_id.'" ');
