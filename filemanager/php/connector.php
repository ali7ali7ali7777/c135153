...
{
	$url = '../admin114/index.php';
	header( "Location: $url" );
	die();
}
include "../admin114/inc_con.php";
...
$url1 = '../../images/object/'.$_SESSION['object_id'].'/';
$url2 = '/../../images/object/'.$_SESSION['object_id'].'/';
$opts = array(
	// 'debug' => true,
	'roots' => array(
		array(
			'driver'        => 'LocalFileSystem',           // driver for accessing file system (REQUIRED)
			'path'          => $url1,                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) .$url2, // URL to files (REQUIRED)
			'accessControl' => 'access',                     // disable and hide dot starting files (OPTIONAL)
			'uploadMaxSize' => '2M',
			'uploadAllow' 	=> array('image/jpeg','image/png','image/jpg'),
