                            ...
                            <div class="c-content-product-2 c-bg-white">
                                ...
                                <div class="btn-group btn-group-justified" role="group">
                                    <div class="btn-group c-border-top" role="group">
                                        <a href="shop-product-wishlist.php?selected=<?php echo $row_i5['object_id']; ?>" class="btn btn-lg c-btn-white c-btn-uppercase c-btn-square c-font-grey-3 c-font-white-hover c-bg-red-2-hover c-btn-product">علاقه مندیها</a>
                                    </div>
                                    <div class="btn-group c-border-left c-border-top" role="group">
                                        <a href="shop-cart.php?selected=<?php echo $row_i5['object_id'];?>" class="btn btn-lg c-btn-white c-btn-uppercase c-btn-square c-font-grey-3 c-font-white-hover c-bg-red-2-hover c-btn-product">سبد خرید</a>
                                    </div>
                                </div>
                            </div>
                        </div>
		...
		?>         
                	<div class="col-md-3 col-sm-6 c-margin-b-20">
                            <div class="c-content-product-2 c-bg-white">
                                ...
                                <div class="btn-group btn-group-justified" role="group">
                                    <div class="btn-group c-border-top\" role="group">
                                        <a href="shop-product-wishlist.php?selected=<?php echo $row_i6['object_id']; ?>" class="btn btn-lg c-btn-white c-btn-uppercase c-btn-square c-font-grey-3 c-font-white-hover c-bg-red-2-hover c-btn-product">علاقه مندیها</a>
                                    </div>
                                    <div class="btn-group c-border-left c-border-top" role="group">
                                        <a href="shop-cart.php?selected=<?php echo $row_i6['object_id']; ?>" class="btn btn-lg c-btn-white c-btn-uppercase c-btn-square c-font-grey-3 c-font-white-hover c-bg-red-2-hover c-btn-product">سبد خرید</a>
                                    </div>
                                </div>
                            </div>
                        </div>
